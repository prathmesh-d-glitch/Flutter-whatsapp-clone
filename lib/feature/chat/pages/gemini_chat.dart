...
class GeminiChat extends ConsumerWidget {
  GeminiChat({super.key});

  UserModel user = UserModel(
    username: 'Gemini AI',
    uid: 'Google-Gemini',
    profileImageUrl: 'https://pin.it/3ER8VD2fN',
    active: true,
    phoneNumber: 'by Google',
    groupId: [],
  );
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/google-gemini-icon.png'),
                    ),
                  ),
                ),
              ),
